...
BADGE_STYLE = (
    "for-the-badge"  # Options: flat, flat-square, plastic, for-the-badge, social
)


def generate_badges(
    file_manifest: Dict[str, FileInfo], repo_path: Path, badge_style: str = BADGE_STYLE
) -> str:
    ...
    if license_files:
        try:
            ...
            if not license_path.exists():
                ...
                badges.append(
                    f"![License](https://img.shields.io/badge/License-Custom-blue.svg?style={badge_style})"
                )
            else:
                ...
                badges.append(
                    f"![License: {license_type}](https://img.shields.io/badge/License-{license_type}-{license_color}.svg?style={badge_style})"
                )
    ...
    if has_docs:
        badges.append(
            f"![Documentation](https://img.shields.io/badge/Documentation-Yes-brightgreen?style={badge_style})"
        )
    ...
    if has_docker:
        badges.append(
            f"![Docker](https://img.shields.io/badge/Docker-2496ED?style={badge_style}&logo=docker&logoColor=white)"
        )
