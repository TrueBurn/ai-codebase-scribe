...
class TestArchitecture(unittest.TestCase):
    ...
    def test_generate_architecture_success(self, mock_llm_client, mock_analyzer_class):
        ...
        mock_llm = AsyncMock()
        mock_llm.generate_architecture_doc = AsyncMock(
            return_value="""
...
"""
    ...
    @patch("src.generators.architecture.CodebaseAnalyzer")
    @patch("src.clients.base_llm.BaseLLMClient")
    def test_generate_architecture_llm_failure(
        self, mock_llm_client, mock_analyzer_class
    ):
    ...
    @patch("src.generators.architecture.CodebaseAnalyzer")
    @patch("src.clients.base_llm.BaseLLMClient")
    def test_generate_architecture_short_content(
        self, mock_llm_client, mock_analyzer_class
    ):
    ...
    @patch("src.generators.architecture.CodebaseAnalyzer")
    @patch("src.clients.base_llm.BaseLLMClient")
    def test_generate_architecture_with_debug(
        self, mock_llm_client, mock_analyzer_class
    ):
...
"""
        ...
        mock_log_info.assert_any_call(
            "Generating architecture documentation for Test Project"
        )
        mock_log_info.assert_any_call(
            "Calling LLM to generate architecture documentation..."
        )
        mock_log_info.assert_any_call(
            "Successfully received architecture content from LLM"
        )
