...
class TestGitHubUtils:
    ...
    async def test_find_existing_pr(self, mock_get_repo):
        ...
        result = find_existing_pr(
            "https://github.com/username/repo", "token", "test-branch"
        )
        ...
        result = find_existing_pr(
            "https://github.com/username/repo", "token", "non-existent-branch"
        )
    ...
    async def test_create_pull_request(self, mock_get_repo):
        ...
        mock_repo.create_pull.assert_called_with(
            title="Test PR", body="Test PR body", head="test-branch", base="main"
        )
